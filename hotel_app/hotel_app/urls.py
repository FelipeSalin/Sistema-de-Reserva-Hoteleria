...
from core.views import login_estatico, registro, reserva, reserva_lista, metodo_pago, detalle_habitacion, retroalimentacion_cliente, iniciar_sesion, perfil_cliente, home_admin
