...
from core.views import login_estatico, registro, reserva, home_cliente, metodo_pago, detalle_habitacion, iniciar_sesion
...
urlpatterns = [
    ...
    path('home_cliente/', iniciar_sesion, nombre=home_cliente),
]
